...
-   Enabled a modernization of the team's reporting framework.  Using the  [Quarto](https://quarto.org/){target="_blank"} framework, I developed a template for the team to share business insight in a variety of outputs for both R and Python developers. This allowed for consistency of reporting, traceability of work, and easy reproducibility.
...
- <i class="fas fa-globe"></i> **Projects**: [connect.posit.cloud/willshelley/](https://connect.posit.cloud/willshelley/content/01977f46-21f7-8c58-7c62-e45d49386629)